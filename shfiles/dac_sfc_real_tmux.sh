...
tmux send-keys -t "${SESSION}:core.2" \
  "cd '${DAC_WS}'; source /opt/ros/noetic/setup.bash; source '${DECOMP_SETUP}'; source '${DAC_WS}/devel/setup.bash'; rosbag record -O '${BAG_PREFIX}' /vins_fusion/imu_propagate /drone_0_planning/trajectory /iris_0/position_cmd /goal_with_id /px4ctrl_2/takeoff_land /mavros/state /mavros/extended_state /drone_0_odom_visualization/robot /drone_0_odom_visualization/path /drone_0_ego_planner_node/dac_sfc/polyhedron_array /drone_0_ego_planner_node/a_star_list /drone_0_ego_planner_node/init_list /drone_0_ego_planner_node/optimal_list /drone_0_ego_planner_node/global_list /drone_0_ego_planner_node/failed_list /drone_0_ego_planner_node/grid_map/occupancy_inflate /tf /tf_static"
